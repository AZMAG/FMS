...
function TermsText() {
    ...
    return (
        <div className="container">
            <h5 className="font-medium text-xl mt-0 mb-2">
                Agreement Between User and MAG Mapping Center
            </h5>
            <p className="mt-0 mb-4">
                The MAG Mapping Center Web Site is comprised of various Web
                pages operated by MAG Mapping Center. The MAG Mapping Center Web
                Site is offered to you conditioned on your acceptance without
                modification of the terms, conditions, and notices contained
                herein. Your use of the MAG Mapping Center Web Site constitutes
            ...
            <p className="mt-0 mb-4">
                MAG Mapping Center reserves the right to change the terms,
                conditions, and notices under which the MAG Mapping Center Web
                Site is offered, including but not limited to the charges
                associated with the use of the MAG Mapping Center Web Site.
            </p>
            <h5 className="font-medium text-xl mt-0 mb-2">
                Links to Third Party Sites
            </h5>
            <p className="mt-0 mb-4">
                The MAG Mapping Center Web Site may contain links to other Web
                Sites ("Linked Sites"). The Linked Sites are not under the
                control of MAG Mapping Center and MAG Mapping Center is not
                responsible for the contents of any Linked Site, including
                without limitation any link contained in a Linked Site, or any
                changes or updates to a Linked Site. MAG Mapping Center is not
                responsible for webcasting or any other form of transmission
                received from any Linked Site. MAG Mapping Center is providing
                these links to you only as a convenience, and the inclusion of
                any link does not imply endorsement by MAG Mapping Center of the
            ...
            <p className="mt-0 mb-4">
                As a condition of your use of the MAG Mapping Center Web Site,
                you warrant to MAG Mapping Center that you will not use the MAG
                Mapping Center Web Site for any purpose that is unlawful or
                prohibited by these terms, conditions, and notices. You may not
                use the MAG Mapping Center Web Site in any manner which could
                damage, disable, overburden, or impair the MAG Mapping Center
                Web Site or interfere with any other party's use and enjoyment
                of the MAG Mapping Center Web Site. You may not obtain or
                attempt to obtain any materials or information through any means
                not intentionally made available or provided for through the MAG
                Mapping Center Web Sites.
            </p>
            <h5 className="font-medium text-xl mt-0 mb-2">
                Use of Communication Services
            </h5>
            <p className="mt-0 mb-4">
                The MAG Mapping Center Web Site may contain bulletin board
                services, chat areas, news groups, forums, communities, personal
                web pages, calendars, and/or other message or communication
                facilities designed to enable you to communicate with the public
                at large or with a group (collectively, "Communication
                Services"), you agree to use the Communication Services only to
            ...
            <p className="mt-0 mb-4">
                MAG Mapping Center has no obligation to monitor the
                Communication Services. However, MAG Mapping Center reserves the
                right to review materials posted to a Communication Service and
                to remove any materials in its sole discretion. MAG Mapping
                Center reserves the right to terminate your access to any or all
                of the Communication Services at any time without notice for any
                reason whatsoever.
            </p>
            <p className="mt-0 mb-4">
                MAG Mapping Center reserves the right at all times to disclose
                ...
                whole or in part, in MAG Mapping Center's sole discretion.
            </p>
            <p className="mt-0 mb-4">
                ...
                Service. MAG Mapping Center does not control or endorse the
                content, messages or information found in any Communication
                Service and, therefore, MAG Mapping Center specifically
                ...
                MAG Mapping Center spokespersons, and their views do not
                necessarily reflect those of MAG Mapping Center.
            </p>
            <p className="mt-0 mb-4">
            ...
            <h5 className="font-medium text-xl mt-0 mb-2">
                Materials Provided to MAG Mapping Center or Posted at Any MAG
                Mapping Center Web Site
            </h5>
            <p className="mt-0 mb-4">
                MAG Mapping Center does not claim ownership of the materials you
                provide to MAG Regional Mapping Center (including feedback and
                suggestions) or post, upload, input or submit to any MAG Mapping
                Center Web Site or its associated services (collectively
                "Submissions"). However, by posting, uploading, inputting,
                providing or submitting your Submission you are granting MAG
                Mapping Center, its affiliated companies and necessary
            ...
            <p className="mt-0 mb-4">
                ...
                Submission, as provided herein. MAG Mapping Center is under no
                obligation to post or use any Submission you may provide and may
                remove any Submission at any time in MAG Mapping Center's sole
                discretion.
            </p>
            <p className="mt-0 mb-4">
            ...
            <p className="mt-0 mb-4">
                ...
                AVAILABLE THROUGH THE MAG MAPPING CENTER WEB SITE MAY INCLUDE
                INACCURACIES OR TYPOGRAPHICAL ERRORS. CHANGES ARE PERIODICALLY
                ADDED TO THE INFORMATION HEREIN. MAG MAPPING CENTER AND/OR ITS
                SUPPLIERS MAY MAKE IMPROVEMENTS AND/OR CHANGES IN THE MAG
                MAPPING CENTER WEB SITE AT ANY TIME. ADVICE RECEIVED VIA THE MAG
                MAPPING CENTER WEB SITE SHOULD NOT BE RELIED UPON FOR PERSONAL,
            ...
            <p className="mt-0 mb-4">
                MAG MAPPING CENTER AND/OR ITS SUPPLIERS MAKE NO REPRESENTATIONS
                ABOUT THE SUITABILITY, RELIABILITY, AVAILABILITY, TIMELINESS,
                AND ACCURACY OF THE INFORMATION, SOFTWARE, PRODUCTS, SERVICES
                AND RELATED GRAPHICS CONTAINED ON THE MAG MAPPING CENTER WEB
                ...
                WARRANTY OR CONDITION OF ANY KIND. MAG MAPPING CENTER AND/OR ITS
            ...
            <p className="mt-0 mb-4">
                ...
                SHALL MAG MAPPING CENTER AND/OR ITS SUPPLIERS BE LIABLE FOR ANY
                ...
                ANY WAY CONNECTED WITH THE USE OR PERFORMANCE OF THE MAG MAPPING
                CENTER WEB SITE, WITH THE DELAY OR INABILITY TO USE THE MAG
                MAPPING CENTER WEB SITE OR RELATED SERVICES, THE PROVISION OF OR
                FAILURE TO PROVIDE SERVICES, OR FOR ANY INFORMATION, SOFTWARE,
                PRODUCTS, SERVICES AND RELATED GRAPHICS OBTAINED THROUGH THE MAG
                MAPPING CENTER WEB SITE, OR OTHERWISE ARISING OUT OF THE USE OF
                THE MAG MAPPING CENTER WEB SITE, WHETHER BASED ON CONTRACT,
                TORT, NEGLIGENCE, STRICT LIABILITY OR OTHERWISE, EVEN IF MAG
                MAPPING CENTER OR ANY OF ITS SUPPLIERS HAS BEEN ADVISED OF THE
                ...
                YOU. IF YOU ARE DISSATISFIED WITH ANY PORTION OF THE MAG MAPPING
                CENTER WEB SITE, OR WITH ANY OF THESE TERMS OF USE, YOUR SOLE
                AND EXCLUSIVE REMEDY IS TO DISCONTINUE USING THE MAG MAPPING
                CENTER WEB SITE.
            </p>
            <p className="mt-0 mb-4">
                SERVICE CONTACT:
            ...
            <p className="mt-0 mb-4">
                MAG Mapping Center reserves the right, in its sole discretion,
                to terminate your access to the MAG Mapping Center Web Site and
                ...
                disputes arising out of or relating to the use of the MAG
                Mapping Center Web Site. Use of the MAG Mapping Center Web Site
                is unauthorized in any jurisdiction that does not give effect to
                all provisions of these terms and conditions, including without
                limitation this paragraph. You agree that no joint venture,
                partnership, employment, or agency relationship exists between
                you and MAG Mapping Center as a result of this agreement or use
                of the MAG Mapping Center Web Site. MAG Mapping Center's
                performance of this agreement is subject to existing laws and
                legal process, and nothing contained in this agreement is in
                derogation of MAG Mapping Center's right to comply with
                governmental, court and law enforcement requests or requirements
                relating to your use of the MAG Mapping Center Web Site or
                information provided to or gathered by MAG Mapping Center with
                ...
                MAG Mapping Center with respect to the MAG Mapping Center Web
                Site and it supersedes all prior or contemporaneous
                communications and proposals, whether electronic, oral or
                written, between the user and MAG Mapping Center with respect to
                the MAG Mapping Center Web Site. A printed version of this
            ...
            <p className="mt-0 mb-4">
                All contents of the MAG Mapping Center Web Site are:
                Copyright&nbsp;
                {DocConfig.copyright} by Maricopa Association of Governments
                and/or its suppliers. All rights reserved.
            </p>
            <h5 className="font-medium text-xl mt-0 mb-2">Trademarks</h5>
            <p className="mt-0 mb-4">
