...
function ReportTypeToggle({ reportType, setReportType }) {
  ...
  return (
    <div className="my-2 mb-6">
      ...
      <button
        className={`mr-1 ${sharedButtonStyle} ${isDetectorActive ? activeButtonStyle : inactiveButtonStyle
          }`}
      ...
      {/* <button
        disabled={true}
        className={`${sharedButtonStyle} ${isDetectorActive ? inactiveButtonStyle : activeButtonStyle
          }`}
